""" 
python attn-nmt.py --devid -1 --nhid 200 --method dot --nlayers 4 --epochs 15 --lr 1e-3 --wd 0 --bsz 64 --clip 5 --maxlen 20 --minfreq 5 --tf 0 --beam 100
"""
import torch
...
if __name__ == '__main__'
    model = LuongAttention(src_vsize = len(DE.vocab.itos), trg_vsize = len(EN.vocab.itos), hidden_dim = args.nhid, method = args.method)
